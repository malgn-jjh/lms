...
while(list.next()) {
    ...
    list.put("today", m.time("yyyy년 MM월 dd일", sysToday));
    list.put("today2", m.time("yyyy.MM.dd", sysToday));
    list.put("certificate_file_url", (!"/data".equals(Config.getDataUrl()) ? "" : siteDomain) + m.getUploadUrl(list.s("background_file")));
