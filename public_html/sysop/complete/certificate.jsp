...
info.put("today", m.time(_message.get("format.date.local"), info.s("complete_date")));
info.put("today2", m.time(_message.get("format.date.dot"), info.s("complete_date")));
info.put("today3", m.time(_message.get("format.dateshort.dot"), info.s("complete_date")));
