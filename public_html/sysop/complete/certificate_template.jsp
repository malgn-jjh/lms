...
//이동
if(info.i("cert_template_id") == 0) { m.jsReplace("certificate.jsp?" + m.qs()); return; }

//정보
DataSet ctinfo = certificateTemplate.find("id = " + info.i("cert_template_id") + " AND site_id = " + siteId + " AND status != -1");
