...
info.put("logo_url", siteDomain + m.getUploadUrl(info.s("logo")));
info.put("logo_ek", m.encrypt(info.s("logo") + m.time("yyyyMMdd")));

info.put("certificate_file_conv", m.encode(info.s("certificate_file")));
info.put("certificate_file_url", siteDomain + m.getUploadUrl(info.s("certificate_file")));
...
info.put("course_file_url", siteDomain + m.getUploadUrl(info.s("course_file")));
