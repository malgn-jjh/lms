...
f.addElement("outline", null, "hname:'도서소개', allowiframe:'Y'");
f.addElement("introduce", null, "hname:'저자소개', allowiframe:'Y'");
f.addElement("contents", null, "hname:'목차', allowiframe:'Y'");
