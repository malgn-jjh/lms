...
if("excel".equals(m.rs("mode"))) {
	ExcelWriter ex = new ExcelWriter(response, "회원접속이력관리(" + m.time("yyyy.MM.dd") + ").xls");
	ex.setData(list, new  String[] { "__ord=>No", "admin_yn_conv=>접속단", "login_type_conv=>구분", "agent=>브라우저", "device=>기기", "ip_addr=>IP", "reg_date_conv=>등록일시" }, "회원접속이력관리(" + m.time("yyyy.MM.dd") + ")");
	ex.write();
	return;
}
