...
lm.setFields("a.cmid, a.umid, a.send_phone, a.dest_phone, a.msg_body, DATE_FORMAT(a.request_time, '%Y-%m-%d %k:%i:%s') request_time, DATE_FORMAT(a.send_time, '%Y-%m-%d %k:%i:%s') send_time, a.exception");
...
while(list.next()) {
	...
	list.put("request_time_conv", m.time("yyyy-MM-dd HH:mm", list.s("request_time")));
	list.put("send_time_conv", m.time("yyyy-MM-dd HH:mm", list.s("send_time")));
//	list.put("request_time_conv", m.time("yyyy-MM-dd HH:mm", list.s("request_time").substring(0, 19)));
//	list.put("send_time_conv", m.time("yyyy-MM-dd HH:mm", list.s("send_time").substring(0, 19)));
}
