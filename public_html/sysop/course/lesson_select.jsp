...
String type = !"B".equals(cinfo.s("onoff_type")) ? cinfo.s("onoff_type") : "";
DataSet types = m.arr2loop("W".equals(siteinfo.s("ovp_vendor")) ? lesson.types : lesson.catenoidTypes);
if("N".equals(cinfo.s("onoff_type"))) types = m.arr2loop("W".equals(siteinfo.s("ovp_vendor")) ? lesson.lessonTypes : lesson.catenoidLessonTypes);
else if("F".equals(cinfo.s("onoff_type"))) types = m.arr2loop(lesson.offlineTypes);
