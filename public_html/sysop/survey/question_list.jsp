...
if("excel".equals(m.rs("mode"))) {
	...
	ex.setData(list, new String[] { "__ord=>No", "id=>고유값", "category_nm=>카테고리", "type_conv=>질문타입", "question=>질문", "item_cnt_conv=>보기개수", "item1=>보기1", "item2=>보기2", "item3=>보기3", "item4=>보기4", "item5=>보기5", "reg_date=>등록일", "status_conv=>상태" }, "설문문항관리(" + m.time("yyyy-MM-dd") + ")");
	ex.write();
	return;
}
