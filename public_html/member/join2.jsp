...
if(isAuth) {
	...
	if(0 < user.findCount("dupinfo = '" + ainfo.s("dupinfo") + "' AND status != -1")) {
		if(!"125.128.232.145".equals(userIp)) {
...
if(!birthdayBlock && 0 < siteconfig.i("join_birthday_status")) f.addElement("birthday_year", null, "hname:'생년월일(년도)'" + (1 < siteconfig.i("join_birthday_status") ? ", required:'Y'" : ""));
if(!birthdayBlock && 0 < siteconfig.i("join_birthday_status")) f.addElement("birthday_month", null, "hname:'생년월일(월)'" + (1 < siteconfig.i("join_birthday_status") ? ", required:'Y'" : ""));
if(!birthdayBlock && 0 < siteconfig.i("join_birthday_status")) f.addElement("birthday_day", null, "hname:'생년월일(일)'" + (1 < siteconfig.i("join_birthday_status") ? ", required:'Y'" : ""));
if(!genderBlock && 0 < siteconfig.i("join_gender_status")) f.addElement("gender", null, "hname:'성별', required:'Y'");
if(!emailBlock && 0 < siteconfig.i("join_email_status")) f.addElement("email1", null, "hname:'이메일', glue:'email2'" + (1 < siteconfig.i("join_email_status") ? ", required:'Y'" : ""));
if(!emailBlock && 0 < siteconfig.i("join_email_status")) f.addElement("email2", null, "hname:'이메일'" + (1 < siteconfig.i("join_email_status") ? ", required:'Y'" : ""));
if(!mobileBlock && 0 < siteconfig.i("join_mobile_status")) f.addElement("mobile1", null, "hname:'휴대폰번호'" + (1 < siteconfig.i("join_mobile_status") ? ", required:'Y'" : ""));
if(!mobileBlock && 0 < siteconfig.i("join_mobile_status")) f.addElement("mobile2", null, "hname:'휴대폰번호'" + (1 < siteconfig.i("join_mobile_status") ? ", required:'Y'" : ""));
if(!mobileBlock && 0 < siteconfig.i("join_mobile_status")) f.addElement("mobile3", null, "hname:'휴대폰번호'" + (1 < siteconfig.i("join_mobile_status") ? ", required:'Y'" : ""));
...
p.setBody((!isGoMobile ? ch : "mobile") + ".join2");
