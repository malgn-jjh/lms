...
if("115.91.52.203".equals(request.getRemoteAddr())) return;
...
// 방문자 고유 아이디
String access_id = m.md5(request.getRemoteAddr() + agent + m.getTimeString());
...
weblog.item("host_ip", request.getRemoteAddr());
weblog.item("os", os);
