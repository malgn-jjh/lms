...
public class LessonDao extends DataObject {
	...
	public String[] htmlTypes = { "01=>wecandio", "02=>lesson", "03=>movie", "04=>link", "05=>catenoid", "06=>doczoom", "07=>catenoid" };
	public String[] useTypes = { "Y=>활성", "N=>비활성" };
	public String[] chatUseTypes = { "Y=>사용", "N=>중지" };

	public String[] types = { "01=>동영상(위캔디오)", "02=>웹콘텐츠(WBT)", "03=>MP4", "04=>외부링크", "06=>문서(닥줌)", "11=>강의", "12=>시험", "13=>실습", "14=>설문" };
	public String[] catenoidTypes = { "05=>동영상(콜러스)", "07=>라이브(콜러스)", "02=>웹콘텐츠(WBT)", "03=>MP4", "04=>외부링크", "06=>문서(닥줌)", "11=>강의", "12=>시험", "13=>실습", "14=>설문" };
	public String[] allTypes = { "01=>동영상(위캔디오)", "05=>동영상(콜러스)", "07=>라이브(콜러스)", "02=>웹콘텐츠(WBT)", "03=>MP4", "04=>외부링크", "06=>문서(닥줌)", "11=>강의", "12=>시험", "13=>실습", "14=>설문" };
	...
	public String[] typesMsg = { "01=>list.lesson.types.01", "02=>list.lesson.types.02", "03=>list.lesson.types.03", "04=>list.lesson.types.04", "06=>list.lesson.types.06", "11=>list.lesson.types.11", "12=>list.lesson.types.12", "13=>list.lesson.types.13", "14=>list.lesson.types.14" };
	...
	public String[] allTypesMsg = { "01=>list.lesson.all_types.01", "05=>list.lesson.01", "02=>list.lesson.02", "03=>list.lesson.all_types.03", "04=>list.lesson.all_types.04", "06=>list.lesson.all_types.06", "11=>list.lesson.all_types.11", "12=>list.lesson.all_types.12", "13=>list.lesson.all_types.13", "14=>list.lesson.all_types.14" };

	public String[] lessonTypesMsg = { "01=>list.lesson.lesson_types.01", "02=>list.lesson.lesson_types.02", "03=>list.lesson.lesson_types.03", "04=>list.lesson.lesson_types.04", "06=>list.lesson.lesson_types.06" };
	public String[] catenoidLessonTypesMsg = { "05=>list.lesson.catenoid_lesson_types.05", "07=>list.lesson.catenoid_lesson_types.07", "02=>list.lesson.catenoid_lesson_types.02", "03=>list.lesson.catenoid_lesson_types.03", "04=>list.lesson.catenoid_lesson_types.04", "06=>list.lesson.catenoid_lesson_types.06" };
	public String[] allLessonTypesMsg = { "01=>list.lesson.all_lesson_types.01", "05=>list.lesson.all_lesson_types.05", "07=>list.lesson.catenoid_lesson_types.07", "02=>list.lesson.all_lesson_types.02", "03=>list.lesson.all_lesson_types.03", "04=>list.lesson.all_lesson_types.04", "06=>list.lesson.all_lesson_types.06" };
