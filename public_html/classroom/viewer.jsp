...
DataSet info = courseLesson.query(
	"SELECT a.* "
	+ ", l.onoff_type, l.lesson_nm, l.start_url, l.mobile_a, l.mobile_i, l.content_width, l.content_height, l.lesson_type, l.total_time, l.complete_time, l.description, l.status lesson_status, l.chat_yn "
...
courseUserLog.item("user_ip_addr", request.getRemoteAddr());
