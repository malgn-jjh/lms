...
// ----------------------------------------------------------------------------------
	...
	try {
		parent.fileupload.location.reload();
...
function init(dialog) {
	...
	UploadScript = oEditor.config.editorPath + 'imageUpload/upload_flash.jsp';
	DeleteScript = oEditor.config.editorPath + 'imageUpload/delete.jsp';
	if(parent.location.pathname.indexOf('mail') != -1) UploadScript += '?mode=mail';
