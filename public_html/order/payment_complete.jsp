<%@ page contentType="text/html; charset=utf-8" %><%@ page import="lgdacom.XPayClient.XPayClient"%><%@ include file="init.jsp" %><%
...
p.setBody(!isGoMobile ? "order.payment_complete" : "mobile.payment_complete");
p.setVar("query", m.qs());
